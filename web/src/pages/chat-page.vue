...
<template>
  ...
  <main class="fade-in mx-auto w-full max-w-5xl flex-1 space-y-4 px-6 py-6">
    <div class="card">
      ...
      <div class="grid grid-cols-12 items-end gap-3">
        ...
        <div class="col-span-6 flex items-center gap-2 md:col-span-1">
          <input
            id="stream-toggle"
            type="checkbox"
        ...
        <div class="col-span-12 flex flex-wrap justify-end gap-2 md:col-span-2">
    ...
    <div class="card">
      <div class="tabs">
        <UiButton
          ...
          >聊天</UiButton
        >
        <UiButton id="tab-image" class="tab" variant="tab" size="sm" @click="switchTab('image')"
          >生图</UiButton
        >
        <UiButton id="tab-video" class="tab" variant="tab" size="sm" @click="switchTab('video')"
          >生成视频</UiButton
        >
      </div>
      ...
      <div id="panel-image" class="hidden">
        ...
        <div class="grid grid-cols-12 items-end gap-3">
          ...
          <div id="image-aspect-wrap" class="col-span-6 hidden md:col-span-2">
          ...
          <div id="image-concurrency-wrap" class="col-span-6 hidden md:col-span-2">
          ...
          <div id="image-generate-wrap" class="col-span-12 flex justify-end md:col-span-2">
            <UiButton
        ...
        <div id="image-continuous-wrap" class="mt-4 hidden">
          <div class="imagine-actions mb-3">
            <UiButton id="image-start-btn" variant="outline" size="xs" @click="startImageContinuous"
              >开始</UiButton
            >
            <UiButton
              id="image-stop-btn"
              ...
              size="xs"
              disabled
              @click="stopImageContinuous"
            >
              停止
            </UiButton>
            <UiButton id="image-clear-btn" variant="outline" size="xs" @click="clearImageWaterfall"
              >清空</UiButton
            >
          </div>
